...
public class ReportingPage extends JFrame{
	...
	private ArrayList<Etape> consulterListe;///
	private JScrollPane scrollPane;
	private JTable table;
	private JScrollPane scrollPane2;
	private JTable table2;
	
	public ReportingPage(ArrayList<Procedure> mesProcedure, ArrayList<Etape> consulterListe) {
		super();
	    ...
	    tp.add("Etape",ConsulterComandePanel);  
	      ...
	      table = new JTable(new ProcedureModel(mesProcedure));
	      ...
	      table2 = new JTable(new EtapeModel(consulterListe));
