...
public class ConsulterDemande {
	...
	private Boolean archiverButtonClicked;
	...
	public ConsulterDemande(String jetonString, String procedureString, Boolean etatBoolean) throws IOException {
		...
		this.archiverButtonClicked = false;
	...
	public Boolean getArchiverButtonClicked() {
		return archiverButtonClicked;
	}


	public void setArchiverButtonClicked(Boolean archiverButtonClicked) {
		this.archiverButtonClicked = archiverButtonClicked;
	}

	public void showPopup() {
		if(!this.archiverButtonClicked)
			showMessageDialog(null, " cette demande est encore de traitement");
		this.archiverButtonClicked = true;
	}
}
